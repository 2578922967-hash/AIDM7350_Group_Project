        ...
        >
            <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-6 border-b border-[#E5E7EB] pb-4">
                ...
                <div className="flex gap-2 mt-4 md:mt-0 text-sm">
                    <button 
                        onClick={() => setLang('en')}
                        className={`px-3 py-1 rounded-full transition-colors ${lang === 'en' ? 'bg-[#D35269] text-white font-bold' : 'bg-[#E5E7EB] text-[#6B7280] hover:bg-[#d1d5db]'}`}
                    >
                        English
                    </button>
                    <button 
                         onClick={() => setLang('cn')}
                         className={`px-3 py-1 rounded-full transition-colors ${lang === 'cn' ? 'bg-[#D35269] text-white font-bold' : 'bg-[#E5E7EB] text-[#6B7280] hover:bg-[#d1d5db]'}`}
                    >
                        中文
                    </button>
                </div>
            ...
            <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <motion.div 
                        ...
                        className="w-24 h-1 bg-[#D35269] mx-auto"
                    />
                </div>
